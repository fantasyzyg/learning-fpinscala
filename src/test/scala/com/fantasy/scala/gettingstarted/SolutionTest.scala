...
import com.fantasy.scala.gettingstarted.Solution._
...
class SolutionTest extends WordSpec with Matchers {
  ...
  "formatResult" should {
    ...
    "work fine with x => { val r = x + 1; r }" in {
      formatResult("increment", 7, x ⇒ {
        val r = x + 1; r
      }) shouldEqual "The increment of 7 is 8"
    }
  }
  ...
  "partial1" should {
    "return partially applied function" in {
      partiall[Int, Int, Int](1, _ + _)(2) shouldEqual 3
    }
  }
